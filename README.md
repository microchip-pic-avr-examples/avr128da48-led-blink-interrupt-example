...
This repository provides a Microchip Studio solution with a bare metal code example for an LED blink driven by a timer overflow interrupt (Timer/Counter Type A).
...
1. Open the *AVRDA_LED_blink_interrupt.atsln* solution in Microchip Studio
